...
class ExpensePanelTest {
	...
	class HappyCases {
		...
		void testInitialConditions() {
			window.textBox("Amount").requireEmpty();
			window.textBox("Date").requireEmpty();
		...
		void testTextFieldContentIsMatching() {
			JTextComponentFixture amountField = window.textBox("Amount");
			JTextComponentFixture dateField = window.textBox("Date");
		...
		void testEnableAddButtonWhenFieldsAreFilled() {
			...
			window.textBox("Amount").setText("100");
			window.textBox("Date").setText("2024-01-01");
		...
		void testShownExpenseShouldMatchExpenseAdded() {
			...
			assertEquals(expense.getId(), model.getValueAt(0, 0),
					"Expense Id in the table should match the added expense");
			assertEquals(expense.getUser().getUsername(), model.getValueAt(0, 1),
					"Expense username in the table should match the added expense");
			assertEquals(expense.getCategory().getName(), model.getValueAt(0, 2),
					"Expense category name in the table should match the added expense");
			assertEquals(expense.getAmount(), model.getValueAt(0, 3),
					"Expense amount in the table should match the added expense");
			assertEquals(expense.getDate(), model.getValueAt(0, 4),
					"Expense date name in the table should match the added expense");
		}
