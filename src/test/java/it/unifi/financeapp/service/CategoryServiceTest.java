...
class CategoryServiceTest {
	...
	class HappyCases {
		...
		void testGetAllCategories() {
			List<Category> expectedCategories = Arrays.asList(new Category("name1", "description1"),
					new Category("name2", "description2"));
	...
	class ErrorCases {
		...
		void testAddCategoryThrowsPersistenceException() {
			Category category = new Category("name", "description");
			doThrow(new PersistenceException("Could not persist category")).when(categoryRepository)
		...
		void testAddCategoryWithNullNameThrowsException() {
			...
			Exception exception = assertThrows(InvalidCategoryException.class,
					() -> categoryService.addCategory(categoryWithNullName));
		...
		void testAddCategoryWithNullDescriptionThrowsException() {
			...
			Exception exception = assertThrows(InvalidCategoryException.class,
					() -> categoryService.addCategory(categoryWithNullDescription));
